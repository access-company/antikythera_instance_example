...
antikythera_dep = {:antikythera, [github: "access-company/antikythera", ref: "d2da0431c064bc42109df1176404e9701b019de8"]}
  ...
  defmodule AntikytheraInstanceExample.Mixfile do
    ...
    defp deps() do
      [
        ...
        {:websocket_client, "1.5.0" , [only: :test]}, # required to run testgear tests (also essential for upgrade_compatibility_test)
